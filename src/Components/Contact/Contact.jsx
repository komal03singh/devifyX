    ...
    <div className='flex flex-col p-4 h-[500px] items-center justify-center'>
      ...
      <div className='py-6'>
        <form action="">
          ...
          <motion.button whileHover={{scale:1.1}} transition={{duration: 0.4, ease:'easeInOut'}} className='p-2 lg:px-6 m-2 border-1 border-cyan-400/80  dark:border-cyan-200/50 rounded-lg font-medium'>Subscribe</motion.button>
        </form>
      </div>
    </div>
